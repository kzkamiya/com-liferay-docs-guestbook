...
if (
 searchBarPortletDisplayContext.isAvailableEverythingSearchScope() ) {
          ...
          out.write("\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t<div class=\"input-group-append input-group-item input-group-item-shrink search-bar-search-button-wrapper\">\n");
          out.write("\t\t\t\t\t\t\t\t");
          //  clay:button
          ...
          _jspx_th_clay_button_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
          ...
          out.write("\t\t\t\t\t\t\t\t<input class=\"form-control input-group-inset input-group-inset-after search-bar-keywords-input\" data-qa-id=\"searchInput\" id=\"");
          ...
          out.write("\n");
          out.write("\n");
          out.write("\t\t\t\t\t\t\t\t<div class=\"input-group-inset-item input-group-inset-item-after search-bar-search-button-wrapper\">\n");
          out.write("\t\t\t\t\t\t\t\t\t");
          //  clay:button
          ...
          _jspx_th_clay_button_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_aui_fieldset_0);
